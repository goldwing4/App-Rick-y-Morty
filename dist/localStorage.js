...
function saveFavorites() {
    localStorage.setItem(favoriteCharactersKey, JSON.stringify(Array.from(favoriteCharacters)));
    localStorage.setItem(favoriteEpisodesKey, JSON.stringify(Array.from(favoriteEpisodes)));
